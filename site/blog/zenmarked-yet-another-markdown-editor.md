...
6. [Wikitext](https://en.wikipedia.org/wiki/Help:Wikitext) I used on the few occasions I contributed to Wikipedia, or used [Mediawiki](https://www.mediawiki.org/wiki/MediaWiki) in other wikis. It's not _that_ lightweight: even though the [formatting basics](https://www.mediawiki.org/wiki/Help:Formatting) are simple enough, Mediawiki's markup [can be extended](https://www.mediawiki.org/wiki/Manual:Extending_wiki_markup) and I think that's allowed Wikipedia to [have](https://en.wikipedia.org/wiki/Help:Score) [so](https://www.mediawiki.org/wiki/Extension:Math) [many](https://www.mediawiki.org/wiki/Extension:ImageMap) [rich](https://en.wikipedia.org/wiki/Wikipedia:Citing_sources) [features](https://www.mediawiki.org/wiki/Extension:SyntaxHighlight).
