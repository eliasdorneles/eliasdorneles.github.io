...
The code is hacky, the template engine only supports the syntax used in my templates and it is not at all properly packaged to be shared, but it works for my needs and it's much faster than my previous setup! You can [peek at the source here](https://github.com/eliasdorneles/eliasdorneles.github.io/tree/e0c19d8218f9ba95da7a120d5d2c26023a05785c/sitegen) if you want to have an idea what it looks like.
